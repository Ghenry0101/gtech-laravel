            ...
            <div class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <form method="POST" action="{{ route('admin.barang.categories.store') }}" class="space-y-6">
                    ...
                    <label class="flex items-center gap-3 text-sm font-medium text-slate-700">
                        ...
                        <input id="is_active" type="checkbox" name="is_active" value="1" class="h-4 w-4 rounded border-slate-300 text-slate-900 focus:ring-slate-500" @checked(old('is_active', true))>
                        {{ __('Kategori Aktif') }}
                    </label>
