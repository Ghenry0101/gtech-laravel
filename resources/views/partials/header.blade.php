<header class="bg-white border-b sticky top-0 z-40 font-aerospace">
  <div class="max-w-[1200px] mx-auto h-14 px-4 sm:px-6 lg:px-8 flex items-center relative">
    ...
    <a href="{{ url('/') }}" class="tracking-wider text-xl">
      <span class="font-black">G</span>-<span class="font-black">TECH</span>
    </a>
    ...
    <form action="{{ route('search') }}" method="GET"
      ...
      <div class="relative">
        <input
          ...
          class="w-100 h-10 rounded-lg border border-slate-300 bg-slate-50 pl-11 pr-4 text-sm outline-none
    ...
    <div class="flex items-center gap-2">
      ...
      <a href="#" class="w-9 h-9 grid place-items-center rounded-md hover:bg-slate-50" title="Cart">
