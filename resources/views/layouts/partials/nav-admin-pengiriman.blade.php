    <nav x-data="{ open: false }" class="border-b border-slate-200 bg-white/90 backdrop-blur">
        @php
            $primaryDashboardRoute = 'admin.shipping.dashboard';
            $navLinks = [
                [
                    'title' => __('Dasbor Pengiriman'),
                    'route' => 'admin.shipping.dashboard',
                    'active' => ['admin.shipping.dashboard', 'admin.shipping.orders.show'],
                    'show' => true,
                ],
            ];
        @endphp
